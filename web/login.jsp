	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
                            <form action="${pageContext.request.contextPath}/LoginController" method="POST" class="login100-form validate-form">
					<span class="login100-form-title p-b-26">
						Chào mừng bạn đến với ChoOnline.com
					</span>
                                        <br>	
                                        <h4 class="error"><%=c%></h4>
                                        <br>
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							<div class="login100-form-bgbtn"></div>
                                                        <button name="btnDangNhap" class="login100-form-btn">
								Đăng Nhập
							</button>
						</div>
					</div>
